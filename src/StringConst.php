...
/**
 * @method static string UnknownEnumVal_TermKind(string $termKind)
 * @method static string UnknownEnumVal_SchemaElementKind(string $schemaElementKind)
 * @method static string UnknownEnumVal_ContainerElementKind(string $containerElementKind)
 * @method static string UnknownEnumVal_TypeKind(string $typeKind)
 * @method static string Annotations_TypeMismatch(string $type, string $attemptedType)
 * @method static string EdmModel_CannotUseElementWithTypeNone()
 * @method static string EdmPrimitive_UnexpectedKind()
 * @method static string EdmModel_Validator_Semantic_DeclaringTypeMustBeCorrect(string $propertyName)
 * @method static string EdmModel_Validator_Semantic_IsUnboundedCannotBeTrueWhileMaxLengthIsNotNull()
 * @method static string EdmEntityContainer_CannotUseElementWithTypeNone()
 * @method static string Constructable_TargetMustBeStock(string $get_class)
 * @method static string Constructable_EntityTypeOrCollectionOfEntityTypeExpected(string $string)
 * @method static string UnknownEnumVal_Multiplicity(string $multiplicity)
 * @method static string Constructable_VocabularyAnnotationMustHaveTarget()
 * @method static string UnknownEnumVal_PrimitiveKind($getKey)
 * @method static string TypeSemantics_CouldNotConvertTypeReference(string|null $param, string $typeKindName)
 * @method static string Bad_CyclicComplex(string|null $qualifiedName)
 * @method static string Bad_CyclicEntityContainer(string $name)
 * @method static string Bad_CyclicEntity(string|null $qualifiedName)
 * @method static string ValueHasAlreadyBeenSet()
 * @method static string UnknownEnumVal_PropertyKind($getKey)
 * @method static string EdmModel_Validator_Semantic_InvalidElementAnnotationNotIEdmStringValue()
 * @method static string EdmModel_Validator_Semantic_InvalidElementAnnotationValueInvalidXml()
 * @method static string EdmModel_Validator_Semantic_InvalidElementAnnotationNullNamespaceOrName()
 * @method static string EdmModel_Validator_Semantic_InvalidElementAnnotationMismatchedTerm()
 * @method static string Serializer_UnknownEdmxVersion()
 * @method static string Serializer_UnknownEdmVersion()
 * @method static string UnknownEnumVal_EdmxTarget($getKey)
 * @method static string ValueWriter_NonSerializableValue($getKey)
 * @method static string EdmModel_Validator_Semantic_ComposableFunctionImportCannotBeSideEffecting(string $getName)
 * @method static string EdmModel_Validator_Semantic_FunctionImportEntitySetExpressionIsInvalid(string $string)
 * @method static string UnknownEnumVal_FunctionParameterMode($getKey)
 * @method static string UnknownEnumVal_ConcurrencyMode($getKey)
 * @method static string Serializer_NonInlineFunctionImportReturnType(string $string)
 * @method static string Annotations_DocumentationPun(string $get_class)
 * @method static string EdmModel_Validator_Syntactic_PropertyMustNotBeNull(string $get_class, string $propertyName)
 * @method static string EdmModel_Validator_Syntactic_EnumPropertyValueOutOfRange(string $get_class, string $propertyName, string $get_class1, $enumValue)
 * @method static string EdmModel_Validator_Syntactic_InterfaceKindValueMismatch($kind, string $get_class, string $propertyName, string $interface)
 * @method static string EdmModel_Validator_Syntactic_InterfaceKindValueUnexpected($kind, string $get_class, string $propertyName)
 * @method static string EdmModel_Validator_Syntactic_TypeRefInterfaceTypeKindValueMismatch(string $get_class, string $getTypeKind)
 * @method static string EdmModel_Validator_Syntactic_EnumerableMustNotHaveNullElements(string $get_class, string $propertyName)
 * @method static string EdmModel_Validator_Syntactic_InterfaceCriticalCycleInTypeHierarchy(string $typeName)
 * @method static string EdmModel_Validator_Syntactic_NavigationPartnerInvalid(string $getName)
 * @method static string EdmModel_Validator_Semantic_AmbiguousType(string $FullName)
 * @method static string EdmModel_Validator_Semantic_InaccessibleType(string $FullName)
 * @method static string EdmModel_Validator_Syntactic_MissingName()
 * @method static string EdmModel_Validator_Syntactic_EdmModel_NameIsTooLong(string $name)
 * @method static string EdmModel_Validator_Syntactic_EdmModel_NameIsNotAllowed(string $name)
 * @method static string EdmModel_Validator_Semantic_ElementDirectValueAnnotationFullNameMustBeUnique(string $NamespaceUri, string $Name)
 * @method static string EdmModel_Validator_Syntactic_MissingNamespaceName()
 * @method static string EdmModel_Validator_Syntactic_EdmModel_NamespaceNameIsTooLong(string $Namespace)
 * @method static string EdmModel_Validator_Syntactic_EdmModel_NamespaceNameIsNotAllowed(string $Namespace)
 * @method static string EdmModel_Validator_Semantic_SystemNamespaceEncountered(string $Namespace)
 * @method static string EdmModel_Validator_Semantic_SchemaElementMustNotHaveKindOfNone(string $FullName)
 * @method static string EdmModel_Validator_Semantic_EntityContainerElementMustNotHaveKindOfNone(string $FullName)
 * @method static string EdmModel_Validator_Semantic_DuplicateEntityContainerMemberName(string $FullName)
 * @method static string EdmModel_Validator_Semantic_EntitySetTypeHasNoKeys(string $entitySetName, string $entityTypeName)
 * @method static string EdmModel_Validator_Semantic_EntitySetCanOnlyBeContainedByASingleNavigationProperty(string $string)
 * @method static string EdmModel_Validator_Semantic_EntitySetNavigationMappingMustBeBidirectional(string $string, string $getName)
 * @method static string EdmModel_Validator_Semantic_DuplicateNavigationPropertyMapping(string $string, string $getName)
 * @method static string EdmModel_Validator_Semantic_EntitySetRecursiveNavigationPropertyMappingsMustPointBackToSourceEntitySet(Interfaces\INavigationProperty $getNavigationProperty, string $getName)
 * @method static string EdmModel_Validator_Semantic_EntitySetNavigationPropertyMappingMustPointToValidTargetForProperty(string $getName, string $getName1)
 * @method static string EdmModel_Validator_Semantic_InvalidMemberNameMatchesTypeName(string $getName)
 * @method static string EdmModel_Validator_Semantic_PropertyNameAlreadyDefined(string $getName)
 * @method static string EdmModel_Validator_Semantic_BaseTypeMustHaveSameTypeKind()
 * @method static string EdmModel_Validator_Semantic_OpenTypesSupportedOnlyInV12AndAfterV3()
 * @method static string EdmModel_Validator_Semantic_OpenTypesSupportedForEntityTypesOnly()
 * @method static string EdmModel_Validator_Semantic_EnumsNotSupportedBeforeV3()
 * @method static string EdmModel_Validator_Semantic_EnumMemberNameAlreadyDefined(string $getName)
 * @method static string EdmModel_Validator_Semantic_EnumMustHaveIntegralUnderlyingType(string $FullName)
 * @method static string EdmModel_Validator_Semantic_EnumMemberTypeMustMatchEnumUnderlyingType(string $getName)
 * @method static string EdmModel_Validator_Semantic_ExpressionNotValidForTheAssertedType()
 * @method static string EdmModel_Validator_Semantic_PrimitiveConstantExpressionNotValidForNonPrimitiveType()
 * @method static string EdmModel_Validator_Semantic_ExpressionPrimitiveKindNotValidForAssertedType()
 * @method static string EdmModel_Validator_Semantic_NullCannotBeAssertedToBeANonNullableType()
 * @method static string EdmModel_Validator_Semantic_PathIsNotValidForTheGivenContext(string $segment)
 * @method static string EdmModel_Validator_Semantic_RecordExpressionNotValidForNonStructuredType()
 * @method static string EdmModel_Validator_Semantic_RecordExpressionMissingProperty(string $getName)
 * @method static string EdmModel_Validator_Semantic_RecordExpressionHasExtraProperties(string $getName)
 * @method static string EdmModel_Validator_Semantic_CollectionExpressionNotValidForNonCollectionType()
 * @method static string EdmModel_Validator_Semantic_StringConstantLengthOutOfRange(int $strlen, int|null $getMaxLength)
 * @method static string string EdmModel_Validator_Semantic_IntegerConstantValueOutOfRange()
 * @method static string EdmModel_Validator_Semantic_ExpressionPrimitiveKindCannotPromoteToAssertedType(string $ToTraceString, string $ToTraceString1)
 * @method static string EdmModel_Validator_Semantic_CannotAssertNullableTypeAsNonNullableType(string|null $FullName)
 * @method static string EdmModel_Validator_Semantic_BinaryConstantLengthOutOfRange(string $strval, int|null $getMaxLength)
 * @method static string EdmModel_Validator_Semantic_DuplicatePropertyNameSpecifiedInEntityKey(string $getName, string $getName1)
 * @method static string EdmModel_Validator_Semantic_InvalidKeyNullablePart(string $getName, string $getName1)
 * @method static string EdmModel_Validator_Semantic_EntityKeyMustBeScalar(string $getName, string $getName1)
 * @method static string EdmModel_Validator_Semantic_EntityKeyMustNotBeBinaryBeforeV2(string $getName, string $getName1)
 * @method static string EdmModel_Validator_Semantic_InvalidKeyKeyDefinedInBaseClass(string $getName, string $getName1)
 * @method static string EdmModel_Validator_Semantic_KeyMissingOnEntityType(string $getName)
 * @method static string EdmModel_Validator_Semantic_KeyPropertyMustBelongToEntity(string $getName, string $getName1)
 * @method static string EdmModel_Validator_Semantic_TypeMustNotHaveKindOfNone()
 * @method static string EdmModel_Validator_Semantic_PrimitiveTypeMustNotHaveKindOfNone(string $FullName)
 * @method static string EdmModel_Validator_Semantic_InvalidComplexTypeAbstract(string $FullName)
 * @method static string EdmModel_Validator_Semantic_InvalidComplexTypePolymorphic(string $FullName)
 * @method static string EdmModel_Validator_Semantic_ComplexTypeMustHaveProperties(string $FullName)
 * @method static string EdmModel_Validator_Semantic_RowTypeMustNotHaveBaseType()
 * @method static string EdmModel_Validator_Semantic_RowTypeMustHaveProperties()
 * @method static string EdmModel_Validator_Semantic_NullableComplexTypeProperty(string $getName)
 * @method static string EdmModel_Validator_Semantic_InvalidPropertyType($getKey)
 * @method static string EdmModel_Validator_Semantic_InvalidPropertyTypeConcurrencyMode(string $param)
 * @method static string EdmModel_Validator_Semantic_InvalidOperationMultipleEndsInAssociation()
 * @method static string EdmModel_Validator_Semantic_InvalidNavigationPropertyType(string $getName)
 * @method static string EdmModel_Validator_Semantic_DuplicateDependentProperty(string $getName, string $getName1)
 * @method static string EdmModel_Validator_Semantic_InvalidMultiplicityOfPrincipalEndDependentPropertiesAllNullable(string $getName, string $getName1)
 * @method static string EdmModel_Validator_Semantic_InvalidMultiplicityOfPrincipalEndDependentPropertiesAllNonnullable(string $getName, string $getName1)
 * @method static string EdmModel_Validator_Semantic_NavigationPropertyPrincipalEndMultiplicityUpperBoundMustBeOne(string $getName)
 * @method static string EdmModel_Validator_Semantic_InvalidMultiplicityOfDependentEndMustBeZeroOneOrOne(string $getName)
 * @method static string EdmModel_Validator_Semantic_InvalidMultiplicityOfDependentEndMustBeMany(string $getName)
 * @method static string EdmModel_Validator_Semantic_DependentPropertiesMustBelongToDependentEntity(string $getName, string $getName1)
 * @method static string EdmModel_Validator_Semantic_InvalidToPropertyInRelationshipConstraint(string $getName, string $FullName)
 * @method static string EdmModel_Validator_Semantic_EndWithManyMultiplicityCannotHaveOperationsSpecified(string $getName)
 * @method static string EdmModel_Validator_Semantic_NavigationPropertyContainsTargetNotSupportedBeforeV3()
 * @method static string EdmModel_Validator_Semantic_NavigationPropertyWithRecursiveContainmentTargetMustBeOptional(string $getName)
 * @method static string EdmModel_Validator_Semantic_NavigationPropertyWithRecursiveContainmentSourceMustBeFromZeroOrOne(string $getName)
 * @method static string EdmModel_Validator_Semantic_NavigationPropertyWithNonRecursiveContainmentSourceMustBeFromOne(string $getName)
 * @method static string EdmModel_Validator_Semantic_NavigationPropertyEntityMustNotIndirectlyContainItself(string $getName)
 * @method static string EdmModel_Validator_Semantic_TypeMismatchRelationshipConstraint(string $getName, string $FullName, string $getName1, string $getName2, string $string)
 * @method static string EdmModel_Validator_Semantic_PropertyMustNotHaveKindOfNone(string $getName)
 * @method static string EdmModel_Validator_Semantic_FunctionsNotSupportedBeforeV2()
 * @method static string EdmModel_Validator_Semantic_OnlyInputParametersAllowedInFunctions(string $getName, string $getName1)
 * @method static string EdmModel_Validator_Semantic_FunctionImportWithUnsupportedReturnTypeV1(string $getName)
 * @method static string EdmModel_Validator_Semantic_FunctionImportWithUnsupportedReturnTypeAfterV1(string $getName)
 * @method static string EdmModel_Validator_Semantic_FunctionImportReturnEntitiesButDoesNotSpecifyEntitySet(string $getName)
 * @method static string EdmModel_Validator_Semantic_FunctionImportEntitySetExpressionKindIsInvalid(string $getName, $getKey)
 * @method static string EdmModel_Validator_Semantic_FunctionImportEntityTypeDoesNotMatchEntitySet(string $getName, string $FullName, string $getName1)
 * @method static string EdmModel_Validator_Semantic_FunctionImportEntityTypeDoesNotMatchEntitySet2(string $getName, string|null $FullName)
 * @method static string EdmModel_Validator_Semantic_FunctionImportSpecifiesEntitySetButNotEntityType(string $getName)
 * @method static string EdmModel_Validator_Semantic_ComposableFunctionImportMustHaveReturnType(string $getName)
 * @method static string EdmModel_Validator_Semantic_FunctionImportParameterIncorrectType(string|null $FullName, string $getName)
 * @method static string EdmModel_Validator_Semantic_FunctionImportSideEffectingNotSupportedBeforeV3()
 * @method static string EdmModel_Validator_Semantic_FunctionImportComposableNotSupportedBeforeV3()
 * @method static string EdmModel_Validator_Semantic_FunctionImportBindableNotSupportedBeforeV3()
 * @method static string EdmModel_Validator_Semantic_BindableFunctionImportMustHaveParameters(string $getName)
 * @method static string EdmModel_Validator_Semantic_InvalidFunctionImportParameterMode(string $getName, string $getName1)
 * @method static string EdmModel_Validator_Semantic_ParameterNameAlreadyDefinedDuplicate(string $getName)
 * @method static string EdmModel_Validator_Semantic_StreamTypeReferencesNotSupportedBeforeV3()
 * @method static string EdmModel_Validator_Semantic_SpatialTypeReferencesNotSupportedBeforeV3()
 * @method static string EdmModel_Validator_Semantic_ScaleOutOfRange()
 * @method static string EdmModel_Validator_Semantic_PrecisionOutOfRange()
 * @method static string EdmModel_Validator_Semantic_StringMaxLengthOutOfRange()
 * @method static string EdmModel_Validator_Semantic_MaxLengthOutOfRange()
 * @method static string EdmModel_Validator_Semantic_SchemaElementNameAlreadyDefined(string $fullName)
 * @method static string EdmModel_Validator_Semantic_DuplicateEntityContainerName(string $getName)
 * @method static string EdmModel_Validator_Semantic_VocabularyAnnotationsNotSupportedBeforeV3()
 * @method static string EdmModel_Validator_Semantic_InaccessibleTarget(string|null $FullyQualifiedName)
 * @method static string EdmModel_Validator_Semantic_InaccessibleTerm(string $FullName)
 * @method static string EdmModel_Validator_Semantic_TypeAnnotationMissingRequiredProperty(string $getName)
 * @method static string EdmModel_Validator_Semantic_TypeAnnotationHasExtraProperties(string $getName)
 * @method static string EdmModel_Validator_Semantic_ValueTermsNotSupportedBeforeV3()
 * @method static string EdmModel_Validator_Semantic_TermMustNotHaveKindOfNone(string $FullName)
