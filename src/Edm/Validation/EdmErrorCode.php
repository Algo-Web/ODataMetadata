 ...
 * @method static self UnknownEdmxVersion()
 * @method static self UnknownEdmVersion()
 * @method static self BadUnresolvedFunction()
 * @method static self InterfaceCriticalEnumPropertyValueOutOfRange()
 * @method static self InterfaceCriticalKindValueMismatch()
 * @method static self InterfaceCriticalKindValueUnexpected()
 * @method static self InterfaceCriticalEnumerableMustNotHaveNullElements()
 * @method static self InterfaceCriticalNavigationPartnerInvalid()
 * @method static self BadUnresolvedType()
 * @method static self DuplicateDirectValueAnnotationFullName()
 * @method static self DuplicateEntityContainerMemberName()
 * @method static self EntitySetTypeHasNoKeys()
 * @method static self EntitySetCanOnlyBeContainedByASingleNavigationProperty()
 * @method static self EntitySetNavigationMappingMustBeBidirectional()
 * @method static self DuplicateNavigationPropertyMapping()
 * @method static self EntitySetRecursiveNavigationPropertyMappingsMustPointBackToSourceEntitySet()
 * @method static self EntitySetNavigationPropertyMappingMustPointToValidTargetForProperty()
 * @method static self BadProperty()
 * @method static self AlreadyDefined()
 * @method static self EntityMustHaveEntityBaseType()
 * @method static self ComplexTypeMustHaveComplexBaseType()
 * @method static self DeclaringTypeMustBeCorrect()
 * @method static self OpenTypeNotSupported()
 * @method static self EnumsNotSupportedBeforeV3()
 * @method static self ExpressionNotValidForTheAssertedType()
 * @method static self PrimitiveConstantExpressionNotValidForNonPrimitiveType()
 * @method static self ExpressionPrimitiveKindNotValidForAssertedType()
 * @method static self NullCannotBeAssertedToBeANonNullableType()
 * @method static self PathIsNotValidForTheGivenContext()
 * @method static self RecordExpressionNotValidForNonStructuredType()
 * @method static self RecordExpressionMissingRequiredProperty()
 * @method static self RecordExpressionHasExtraProperties()
 * @method static self CollectionExpressionNotValidForNonCollectionType()
 * @method static self StringConstantLengthOutOfRange()
 * @method static self IntegerConstantValueOutOfRange()
 * @method static self CannotAssertNullableTypeAsNonNullableType()
 * @method static self BinaryConstantLengthOutOfRange()
 * @method static self DuplicatePropertySpecifiedInEntityKey()
 * @method static self InvalidKey()
 * @method static self EntityKeyMustBeScalar()
 * @method static self EntityKeyMustNotBeBinary()
 * @method static self KeyMissingOnEntityType()
 * @method static self KeyPropertyMustBelongToEntity()
 * @method static self InvalidAbstractComplexType()
 * @method static self InvalidPolymorphicComplexType()
 * @method static self ComplexTypeMustHaveProperties()
 * @method static self RowTypeMustHaveProperties()
 * @method static self NullableComplexTypeProperty()
 * @method static self InvalidPropertyType()
 * @method static self InvalidAction()
 * @method static self InvalidNavigationPropertyType()
 * @method static self DuplicateDependentProperty()
 * @method static self InvalidMultiplicityOfPrincipalEnd()
 * @method static self InvalidMultiplicityOfDependentEnd()
 * @method static self DependentPropertiesMustBelongToDependentEntity()
 * @method static self InvalidPropertyInRelationshipConstraint()
 * @method static self EndWithManyMultiplicityCannotHaveOperationsSpecified()
 * @method static self NavigationPropertyContainsTargetNotSupportedBeforeV3()
 * @method static self NavigationPropertyWithRecursiveContainmentTargetMustBeOptional()
 * @method static self NavigationPropertyWithRecursiveContainmentSourceMustBeFromZeroOrOne()
 * @method static self NavigationPropertyWithNonRecursiveContainmentSourceMustBeFromOne()
 * @method static self NavigationPropertyEntityMustNotIndirectlyContainItself()
 * @method static self TypeMismatchRelationshipConstraint()
 * @method static self FunctionsNotSupportedBeforeV2()
 * @method static self FunctionImportUnsupportedReturnType()
 * @method static self FunctionImportReturnsEntitiesButDoesNotSpecifyEntitySet()
 * @method static self FunctionImportEntityTypeDoesNotMatchEntitySet()
 * @method static self FunctionImportSpecifiesEntitySetButDoesNotReturnEntityType()
 * @method static self ComposableFunctionImportMustHaveReturnType()
 * @method static self FunctionImportSideEffectingNotSupportedBeforeV3()
 * @method static self FunctionImportComposableNotSupportedBeforeV3()
 * @method static self FunctionImportBindableNotSupportedBeforeV3()
 * @method static self ComposableFunctionImportCannotBeSideEffecting()
 * @method static self BindableFunctionImportMustHaveParameters()
 * @method static self StreamTypeReferencesNotSupportedBeforeV3()
 * @method static self SpatialTypeReferencesNotSupportedBeforeV3()
 * @method static self ScaleOutOfRange()
 * @method static self PrecisionOutOfRange()
 * @method static self MaxLengthOutOfRange()
 * @method static self IsUnboundedCannotBeTrueWhileMaxLengthIsNotNull()
 * @method static self DuplicateEntityContainerName()
 * @method static self VocabularyAnnotationsNotSupportedBeforeV3()
 * @method static self BadUnresolvedTarget()
 * @method static self BadUnresolvedTerm()
 * @method static self TypeAnnotationMissingRequiredProperty()
 * @method static self TypeAnnotationHasExtraProperties()
 * @method static self ValueTermsNotSupportedBeforeV3()
 * @method static self IncorrectNumberOfArguments()
 * @method static self DuplicateAnnotation()
 */
