 ...
 *
 * The Edm:ValueTermReference expression MUST contain a value of the type [qualifiedname][csdl19]. The value of the
 * value term reference expression MUST resolve to a valid signature of a value term.
