# ODataMetadata Contributor's Guide
...
Ok, we're not quite there yet with ODataMetadata, but there, I've written
it down as an explicit goal.

* **Eat.  Sleep.  PSR-2.  Repeat.**
As ODataMetadata is a Composer package, we apply the PSR-2 coding
