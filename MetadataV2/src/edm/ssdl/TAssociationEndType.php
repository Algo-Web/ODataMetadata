...
class TAssociationEndType
{
    ...
    /**
     * @property \MetadataV2\edm\ssdl\TOnActionType[] $onDelete
     */
     ...
     *
     * @return self
     * @param \MetadataV2\edm\ssdl\TOnActionType $onDelete
     */
    public function addToOnDelete(\MetadataV2\edm\ssdl\TOnActionType $onDelete)
    {
     ...
     * Gets as onDelete
     *
     * @return \MetadataV2\edm\ssdl\TOnActionType[]
     */
