...
class TComplexPropertyType
{
    ...
    /**
     * @property \MetadataV2\mapping\cs\TComplexTypeMappingType[] $complexTypeMapping
     */
     ...
     */
    public function addToComplexProperty(\MetadataV2\mapping\cs\TComplexPropertyType $complexProperty)
    {
     ...
     *
     * @return self
     * @param \MetadataV2\mapping\cs\TComplexTypeMappingType $complexTypeMapping
     */
    public function addToComplexTypeMapping(\MetadataV2\mapping\cs\TComplexTypeMappingType $complexTypeMapping)
    {
     ...
     *
     * @return \MetadataV2\mapping\cs\TComplexTypeMappingType[]
     */
