...
class TDiagramType
{
    ...
    /**
     * @property \MetadataV3\edmx\TEntityTypeShapeType[] $entityTypeShape
     */
    ...
    /**
     * @property \MetadataV3\edmx\TAssociationConnectorType[] $associationConnector
     */
    ...
    /**
     * @property \MetadataV3\edmx\TInheritanceConnectorType[] $inheritanceConnector
     */
     ...
     *
     * @return self
     * @param \MetadataV3\edmx\TEntityTypeShapeType $entityTypeShape
     */
    public function addToEntityTypeShape(\MetadataV3\edmx\TEntityTypeShapeType $entityTypeShape)
    {
     ...
     *
     * @return \MetadataV3\edmx\TEntityTypeShapeType[]
     */
     ...
     *
     * @return self
     * @param \MetadataV3\edmx\TAssociationConnectorType $associationConnector
     */
    public function addToAssociationConnector(\MetadataV3\edmx\TAssociationConnectorType $associationConnector)
    {
     ...
     *
     * @return \MetadataV3\edmx\TAssociationConnectorType[]
     */
     ...
     *
     * @return self
     * @param \MetadataV3\edmx\TInheritanceConnectorType $inheritanceConnector
     */
    public function addToInheritanceConnector(\MetadataV3\edmx\TInheritanceConnectorType $inheritanceConnector)
    {
     ...
     *
     * @return \MetadataV3\edmx\TInheritanceConnectorType[]
     */
