...
class TAssociationEndType
{
    ...
    /**
     * @property \MetadataV3\edm\TOnActionType[] $onDelete
     */
     ...
     *
     * @return self
     * @param \MetadataV3\edm\TOnActionType $onDelete
     */
    public function addToOnDelete(\MetadataV3\edm\TOnActionType $onDelete)
    {
     ...
     * Gets as onDelete
     *
     * @return \MetadataV3\edm\TOnActionType[]
     */
