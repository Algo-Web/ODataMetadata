...
class AssociationSetAnonymousType
{
    ...
    /**
     * @property
     * \MetadataV1\edm\EntityContainer\AssociationSetAnonymousType\EndAnonymousType[]
     * $end
     */
    private $end = array(
     ...
     * $end
     */
    public function addToEnd(\MetadataV1\edm\EntityContainer\AssociationSetAnonymousType\EndAnonymousType $end)
    {
        $this->end[] = $end;
        return $this;
    }
