...
class TAssociationEndType
{
    ...
    /**
     * @property \MetadataV1\edm\ssdl\TOnActionType[] $onDelete
     */
     ...
     *
     * @return self
     * @param \MetadataV1\edm\ssdl\TOnActionType $onDelete
     */
    public function addToOnDelete(\MetadataV1\edm\ssdl\TOnActionType $onDelete)
    {
     ...
     * Gets as onDelete
     *
     * @return \MetadataV1\edm\ssdl\TOnActionType[]
     */
