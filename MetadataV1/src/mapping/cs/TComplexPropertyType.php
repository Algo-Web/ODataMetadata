...
class TComplexPropertyType
{
    ...
    /**
     * @property \MetadataV1\mapping\cs\TComplexTypeMappingType[] $complexTypeMapping
     */
     ...
     */
    public function addToComplexProperty(\MetadataV1\mapping\cs\TComplexPropertyType $complexProperty)
    {
     ...
     *
     * @return self
     * @param \MetadataV1\mapping\cs\TComplexTypeMappingType $complexTypeMapping
     */
    public function addToComplexTypeMapping(\MetadataV1\mapping\cs\TComplexTypeMappingType $complexTypeMapping)
    {
     ...
     *
     * @return \MetadataV1\mapping\cs\TComplexTypeMappingType[]
     */
