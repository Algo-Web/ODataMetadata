...
class TDiagramType
{
    ...
    /**
     * @property \MetadataV1\edmx\TEntityTypeShapeType[] $entityTypeShape
     */
    ...
    /**
     * @property \MetadataV1\edmx\TAssociationConnectorType[] $associationConnector
     */
    ...
    /**
     * @property \MetadataV1\edmx\TInheritanceConnectorType[] $inheritanceConnector
     */
     ...
     *
     * @return self
     * @param \MetadataV1\edmx\TEntityTypeShapeType $entityTypeShape
     */
    public function addToEntityTypeShape(\MetadataV1\edmx\TEntityTypeShapeType $entityTypeShape)
    {
     ...
     *
     * @return \MetadataV1\edmx\TEntityTypeShapeType[]
     */
     ...
     *
     * @return self
     * @param \MetadataV1\edmx\TAssociationConnectorType $associationConnector
     */
    public function addToAssociationConnector(\MetadataV1\edmx\TAssociationConnectorType $associationConnector)
    {
     ...
     *
     * @return \MetadataV1\edmx\TAssociationConnectorType[]
     */
     ...
     *
     * @return self
     * @param \MetadataV1\edmx\TInheritanceConnectorType $inheritanceConnector
     */
    public function addToInheritanceConnector(\MetadataV1\edmx\TInheritanceConnectorType $inheritanceConnector)
    {
     ...
     *
     * @return \MetadataV1\edmx\TInheritanceConnectorType[]
     */
